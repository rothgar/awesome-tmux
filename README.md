...
- [glazier](https://github.com/wilhelm-murdoch/glazier) Declaratively manage tmux sessions, windows, panes and other things with Terraform-like HCL-based configuration files.
