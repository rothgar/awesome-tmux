...
- [run-kit](https://github.com/sahil87/run-kit) Remote, phone-first web console for tmux — spawn and watch coding agents (or anything else) in parallel git worktrees; agent-agnostic, no database
