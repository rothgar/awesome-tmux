...
- [tmux-agentwatch](https://github.com/austinwilcox/tmux-agentwatch) Track coding agent state (working, waiting, done) straight from the agent's own hooks — window flags, desktop notifications, and one key to jump to whoever has waited longest.
