...
- [Bento Term](https://github.com/NovaShang/BentoTerm) Native macOS/iOS client for tmux control mode (-CC) that shows each pane's AI agent state, with push-to-talk voice input
