...
- [tmux-wireguard](https://github.com/mgalgs/tmux-wireguard) Show active WireGuard (and Tailscale) interfaces, with data transfer and last handshake in verbose mode.
