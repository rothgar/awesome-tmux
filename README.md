...
- [tmuxai](https://github.com/alvinunreal/tmuxai) AI-Powered, non-intrusive terminal assistant based on tmux
...
- [gruvbox-tmux](https://gitlab.com/motaz-shokry/gruvbox-tmux): A clean  Tmux theme that  follows the [gruvbox](https://github.com/morhetz/gruvbox) colors, Inspired by [tmux-tokyo-night](https://github.com/fabioluciano/tmux-tokyo-night).
