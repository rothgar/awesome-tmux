...
- [nightmux](https://github.com/mmr710/nightmux) Drive Claude Code, Codex, or any terminal agent inside a tmux session from Telegram; single-file Python daemon, no dependencies.
