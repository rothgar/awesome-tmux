...
- [Argus](https://github.com/andreaderuvo/argus) A self-hosted browser workspace around existing tmux sessions, with terminals, file and document previews, alerts, persistent layouts, and mobile controls.
