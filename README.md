...
- [Codeman](https://github.com/Ark0N/Codeman) A self-hosted web dashboard that runs AI coding agents (Claude Code, OpenCode, Codex, Gemini) in persistent tmux sessions, streamed live to any browser or phone
