...
- [ttyd-web-control](https://github.com/jjabroin/ttyd-web-control) Control your tmux terminal from iPhone/iPad Safari with touch scrolling, a shortcut bar and file upload
