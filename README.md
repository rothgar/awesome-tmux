...
- [tmux-pane-focus](https://github.com/graemedavidson/tmux-pane-focus) Plugin auto resizes panes when selecing a new active pane to give more space to active pane whilst leaving inactive panes legiable.
